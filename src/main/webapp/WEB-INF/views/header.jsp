				...
				<div class="row">
					...
					<div class="col-md-6">
						<form class="omb_loginForm" action="logout" autocomplete="off"
							...
							<div class="main-heading text-center"
								style="font-family: BEBAS; font-size: 34px; margin-top: 43px; text-align: center; color: #000080;">
								UCCX Campaign Manager</div>
					...
					<div class="col-md-3">
						<div class="pull-right" align='right'>
							...
							<!-- 	<a class='btn-primary'
									href="http://10.1.6.196:8080/UCCXCampaignManager/"
									style='width: 125px'>Logout</a> <a class='btn-primary'
									href="http://10.1.6.196:8080/UCCXCampaignManager/"
									style="padding-left: 20px; width: 125px;">Home</a> -->

								<a class='btn-primary' href="http://localhost:8080/UCCXCampaignManager/" style='width: 125px'>Logout</a>
								<a class='btn-primary' href="http://localhost:8080/UCCXCampaignManager/"
									style="padding-left: 20px; width: 125px;">Home</a>
							</div>
						</div>
					</div>
